...
optional `scripts/install-skills.mjs` installs the real Agent Skills into `.kiro/skills/` by downloading
the same pinned version (the only path that fetches at "user" time).
