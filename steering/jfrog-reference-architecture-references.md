---
inclusion: manual
name: jfrog-reference-architecture-references
description: "Deep reference material for the jfrog-reference-architecture skill (API paths, schemas, workflows)."
---
