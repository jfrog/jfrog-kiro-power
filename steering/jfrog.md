...
> **Deep reference material** for this skill is in the `#jfrog-references` steering file (manual inclusion) — load it when you need API paths, schemas, AQL syntax, or detailed workflows.
